    ...
    process(prefix, message) {
        ...
        try {
            ...
            for (let command of this.#commands) {
                if (command.name == firstToken.value) matchers.push(new HandlerCommandMatcher(command));
            }
