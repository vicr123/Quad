...
const {Interaction, Guild, User} = require("discord.js");
...
async function trForDescriptor(translator) {
	if (translator.constructor === Interaction) {
		// Translate for the author
		translator = translator.user;
	}

	if (translator.constructor === Guild || translator.constructor === User) {
		// Translate for a Snowflake
